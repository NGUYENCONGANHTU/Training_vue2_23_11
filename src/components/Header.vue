    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-7">
          ...
          <div class="col"></div>
          <div class="col">
            <a href=""><router-link to="/2">Random</router-link></a>
          </div>
          <div class="col">
            <a href=""><router-link to="/8">Test Nhân Phẩm</router-link></a>
          </div>
        </div>
      </div>
    </div>
    <div class="main-container">
      <div class="container">
        <div class="row">
          <div class="col-6">
            <h3>
              Random: <span><b>VIETLOTT</b></span>
            </h3>
            <h2><a href="">Tại đây</a></h2>
            <ul class="content__container__list">
              <li class="content__container__list__item xl:pl-3">
                Nhanh chóng
              </li>
              <li class="content__container__list__item xl:pl-3">Chất lượng</li>
              <li class="content__container__list__item xl:pl-3">Uy tín</li>
              <li class="content__container__list__item xl:pl-3">
                Tại sao không?
              </li>
            </ul>
            <h1>Chúc các bạn may mắn!!!</h1>
          </div>
          <div class="col-6">
            <img
              src="https://media.dautuvakinhdoanh.vn/thumb_x400x/images/2022/01/13/9897-1642062966-logo-power-655-big.jpg"
              alt=""
            />
          </div>
        </div>
